...
label=Label(top, text="Coeficiente bloque y esfera (e):")
label.place(x=0,y=80+400)
txt = Entry(top,width=10)
txt.place(x=190,y=80+400)
Label(top,text="kg").place(x=260,y=100+400)
Label(top,text="kg").place(x=260,y=120+400)
Label(top,text="m/s").place(x=260,y=140+400)
label1=Label(top, text="Masa esfera A, en kilogramos:")
label1.place(x=0,y=100+400)
txt1 = Entry(top,width=10)
txt1.place(x=190,y=100+400)
